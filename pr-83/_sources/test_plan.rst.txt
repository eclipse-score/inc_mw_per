...
.. document:: Persistency Software Verification Plan
    ...
    :security: NO
    :safety: QM
    :realizes: S-CORE_PROCESS_wp__verification__plan
...
#. **Unit/Module Level**: Focuses on testing individual functions of the KVS module in isolation from the rest of the system. The goal is to verify the logical correctness of the code.
#. **Component Integration Level**: Tests the KVS module along with the storage driver or file system it directly depends on. The goal is to verify the interfaces and interactions between these closely coupled components.
#. **Platform Level**: Tests the fully integrated KVS module on the reference hardware. The goal is to verify non-functional requirements like performance and robustness in a production-representative environment.
...
https://eclipse-score.github.io/process_description/main/process_areas/verification/guidance/verification_methods.html
...
.. list-table:: Work Products and Traceability
    ...
    * - Test Scripts
      ...
      - Github Repository
    * - Test Reports
      - The results of each test execution cycle.
...
#. **Reference Hardware**: External hardware board connected to a PC via debugging probes and a controllable power supply for automated system and robustness testing.
...
| **CI Runner image**: https://github.com/qorix-group/gh_action_runner_image
